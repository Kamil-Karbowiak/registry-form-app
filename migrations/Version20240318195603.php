 ...
 */
final class Version20240318195603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE developer (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', integrated_development_environments VARCHAR(255) NOT NULL, programming_languages VARCHAR(255) NOT NULL, has_my_sqlknowledge TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
