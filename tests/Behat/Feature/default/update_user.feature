Feature: Update user
  ...
  Scenario: Happy path
    When I send a PATCH request to "/users/018e55dc-5305-7fd1-9c7b-5dc91133cd59" with body:
    """
      {
          "first_name": "Tester",
          "last_name": "Testowy",
  ...
  Scenario: 404 - not found
    When I send a PATCH request to "/users/018e55dc-5305-7fd1-9c7b-0000000000"
