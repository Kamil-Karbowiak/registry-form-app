Feature: Update user
  ...
  Scenario: Happy path
    When I send a DELETE request to "/api/users/018e55db-e90d-7ea3-b599-47b9fcf1dd4d"
    Then the response code is 204

  Scenario: 404 - not found
    When I send a DELETE request to "/api/users/018e55db-e90d-7ea3-b599-47b9fcf10000"
